...
# and write the contents into the second file (creating it if necessary). If the
...
# closing files, your program should catch the exception, print an error message,
# and exit.
import re
